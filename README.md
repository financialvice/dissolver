...
<video src="https://github.com/financialvice/dissolver/raw/main/demo.mp4" controls></video>

- build: `swift build -c release && cp .build/release/Dissolver /usr/local/bin/dissolver`
- run: `dissolver`
